...
<div class="cv">
  <aside class="cv-sidebar">
    <div class="cv-photo">
      <img src="foto.jpeg" alt="Portrait" class="portrait">
    </div>
    ...
    <div class="social-links">
      ...
      <a class="icon-button" href="https://orcid.org/0009-0000-2790-9781" aria-label="ORCID">
        <span class="icon-orcid" aria-hidden="true"></span>
      </a>
    </div>
  ...
  <main class="cv-main">
    ...
    <section>
      ...
      <div class="cv-item">
        <div class="cv-item-heading">
          <span>Performance Scholarship, University of Vienna</span>
          <span>11/2025</span>
        </div>
        <p>Awarded for outstanding academic achievements.</p>
      </div>
